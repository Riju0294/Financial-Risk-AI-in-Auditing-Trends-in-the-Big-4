...
/* 13. AI Usage Impact on High-Risk Cases 

Does using AI in auditing reduce the number of high-risk cases? */

SELECT AI_Used_for_Auditing, 
       round(AVG(High_Risk_Cases),2) AS Avg_High_Risk_Cases
FROM f_risk
GROUP BY AI_Used_for_Auditing
ORDER BY AI_Used_for_Auditing;